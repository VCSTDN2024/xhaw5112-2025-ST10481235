...
The website provides a digital solution to increase student engagement, accessibility, and communication through a user-friendly website.

**The solution includes:**

The website was developed in React Native with easy navigation between each screen.
...
Has a professional layout which builds trust with customers
Users have the ability to browse and purchase from the website inside of having to purchase in person. 
...
React Native (Expo) – For development of website
...
Implementation: Developed the React Native website and integrated navigation
